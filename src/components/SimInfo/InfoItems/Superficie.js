...
const Superficie = () => {
    ...
    const [supWidth, setSupWidth] = useState('000');
    const [supHeight, setSupHeight] = useState('000');
        ...
        <div style={styles.container}>
           ...
           <div style={styles.item}>
               ...
               <div style={styles.width}>
                    ...
                    <p style={styles.values}>{supWidth} m2.</p>
               </div>
               <div style={styles.height}>
                    ...
                    <p style={styles.values}>{supHeight} m2.</p>
               </div>
           </div>
        </div>
